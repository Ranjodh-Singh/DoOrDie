 ...
 *	@see <a href="http://www.geeksforgeeks.org/find-the-element-that-appears-once/">link</a>
 */
public class FindSingles {
	...
	/* Explanation from CarrerCup @see <a href="http://www.careercup.com/question?id=7902674">link</a>
	 * 
	 * he code works in similar line with the question of "finding the element which appears once in an array - containing other elements each appearing twice". Solution is to XOR all the elements and you get the answer. 
